    ...
    return (
      <div className="container">
        ...
        <div className="row">
          ...
          <div className="col-md-8">{!this.state.sent ? <ContactForm data={this.state.contact} onChange={this.contactChanged} onSubmit={this.sendContact} /> : <Message header="Thank you" text="Your message has been sent" />}</div>
        </div>
      </div>
    );
  }
